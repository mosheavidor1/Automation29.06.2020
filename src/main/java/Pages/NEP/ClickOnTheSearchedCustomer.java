...
//"div-class[@label='TrustwaveEP Test #6']"

    public static final By ClickOnSelected = By.xpath("//span[contains(text(),'agent-default')]");
   ...
   @FindBy(how = How.XPATH, using = "//span[contains(text(),'agent-default')]")
